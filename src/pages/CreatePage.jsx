            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-white/40 text-sm mt-2">
                  De frente, buena luz, que se vea bien la cara. La magia depende de esto.
                </p>
              </div>

              <div 
                onClick={() => fileInputRef.current?.click()}
                className={`relative rounded-2xl border-2 border-dashed p-8 text-center cursor-pointer transition-all ${errors.honoreePhoto ? 'border-red-500/50 bg-red-500/5' : 'border-white/20 hover:border-[#FFD700]/50 bg-white/[0.02]'}`}
              >
                <input 
                  type="file" 
                  ref={fileInputRef}
                ...
                {previewUrl ? (
                  <div className="relative">
                    ...
                    <button 
                      onClick={(e) => {
                        e.stopPropagation()
                        setPreviewUrl(null)
                        setFormData({ ...formData, honoreePhoto: '' })
                      }}
                  ...
                  <>
                    <div className="w-16 h-16 rounded-full bg-[#FFD700]/10 flex items-center justify-center mx-auto mb-4">
                      <Camera size={28} className="text-[#FFD700]" />
                    </div>
              ...
              {errors.honoreePhoto && (
                <p className="text-red-400 text-xs text-center">{errors.honoreePhoto}</p>
              )}
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-[#FFD700]/5 border border-[#FFD700]/10">
                ...
                <p className="text-white/50 text-xs">
                  La imagen que subas se ELIMINA una vez creada la figurita y NO permanece en nuestro sistema.
                </p>
              </div>
            </motion.div>
          )}
          ...
          {step === 2 && (
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-white/40 text-sm mt-2">
                  La camiseta de tu equipo, con escudo propio.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {TEAMS.map((team) => (
                  <button
                    ...
                    className={`p-4 rounded-xl border transition-all ${formData.team === team.id ? 'border-[#FFD700] bg-[#FFD700]/10' : 'border-white/10 bg-white/[0.02] hover:border-white/20'}`}
                  >
                    <div className="w-12 h-12 mx-auto mb-2">
                      <img src={team.shield} alt={team.name} className="w-full h-full object-contain" />
                    </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Thiago"
                    className={`w-full px-4 py-3 rounded-xl bg-white/5 border ${errors.childName ? 'border-red-500/50' : 'border-white/10'} text-white placeholder-white/30 focus:border-[#FFD700]/50 focus:outline-none transition-colors`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateField('honoreeAge', e.target.value)}
                    placeholder="8"
                    min="1"
                    max="18"
                    className={`w-full px-4 py-3 rounded-xl bg-white/5 border ${errors.honoreeAge ? 'border-red-500/50' : 'border-white/10'} text-white placeholder-white/30 focus:border-[#FFD700]/50 focus:outline-none transition-colors`}
                  />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl bg-white/5 border ${errors.date ? 'border-red-500/50' : 'border-white/10'} text-white focus:border-[#FFD700]/50 focus:outline-none transition-colors`}
                  />
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl bg-white/5 border ${errors.startTime ? 'border-red-500/50' : 'border-white/10'} text-white focus:border-[#FFD700]/50 focus:outline-none transition-colors`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl bg-white/5 border ${errors.endTime ? 'border-red-500/50' : 'border-white/10'} text-white focus:border-[#FFD700]/50 focus:outline-none transition-colors`}
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Club Atlético River Plate"
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:border-[#FFD700]/50 focus:outline-none transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Av. Figueroa Alcorta 7597, CABA"
                    className={`w-full px-4 py-3 rounded-xl bg-white/5 border ${errors.address ? 'border-red-500/50' : 'border-white/10'} text-white placeholder-white/30 focus:border-[#FFD700]/50 focus:outline-none transition-colors`}
                  />
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className="px-3 py-3 rounded-xl bg-white/5 border border-white/10 text-white/60 flex items-center">
                      <span className="text-sm">🇦🇷 +54</span>
                    </div>
                    <input
                      type="tel"
                      value={formData.contactWhatsApp}
                      onChange={(e) => updateField('contactWhatsApp', e.target.value.replace(/\D/g, ''))}
                      placeholder="9 11 1234 5678"
                      className="flex-1 px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:border-[#FFD700]/50 focus:outline-none transition-colors"
                    />
                  </div>
                </div>
              </div>
          ...
          {step === 5 && (
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-white/40 text-sm mt-2">
                  Un texto corto que aparece debajo de la figurita. Es opcional.
                </p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="¡Nos vemos en mi cumple! Traer pelota ⚽"
                  rows={3}
                  maxLength={100}
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:border-[#FFD700]/50 focus:outline-none transition-colors resize-none"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl bg-white/5 border ${errors.email ? 'border-red-500/50' : 'border-white/10'} text-white placeholder-white/30 focus:border-[#FFD700]/50 focus:outline-none transition-colors`}
                />
                {errors.email && <p className="text-red-400 text-xs mt-1">{errors.email}</p>}
              </div>

              {/* Preview de lo que se va a crear */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-xs">
                      {formData.honoreeAge || '--'} años · {TEAMS.find(t => t.id === formData.team)?.name || 'Argentina'}
                    </p>
                    <p className="text-white/40 text-xs">
...
{step === 6 && createdInvitation && (
            ...
            >
              <div className="text-center mb-4">
                <motion.div
                  ...
                  className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#FFD700]/20 flex items-center justify-center"
                >
              ...
              >
                <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">{formData.date || '--'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/10">
                  <Clock size={16} className="text-[#FFD700]" />
                  <div>
                    <p className="text-white/40 text-[10px] uppercase tracking-wider">Horario</p>
                ...
                <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/10">
                  ...
                  <div>
                    <p className="text-white/40 text-[10px] uppercase tracking-wider">Lugar</p>
                    <p className="text-white text-sm">{formData.location || formData.address || '--'}</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-[#0a0e27] font-bold text-lg tracking-wide hover:opacity-90 transition-all shadow-lg shadow-[#FFD700]/20"
                >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#050505]/95 backdrop-blur-xl">
            <div className="text-center">
              ...
              <motion.h3
                ...
                className="text-2xl font-black font-bebas text-[#FFD700] mb-2"
              >
                Creando la figurita...
              </motion.h3>
                  ...
                  <div className="relative px-6 pt-8 pb-6 text-center">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-sm text-gray-300">
                        {formData.childName} ya tiene su figurita lista.
                      </p>
                    </div>
                  </div>
        ...
        {/* Botones de navegación (solo pasos 1-5) */}
        {step <= 5 && (
          <div className="fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-[#050505] via-[#050505]/80 to-transparent">
            <div className="max-w-lg mx-auto flex gap-3">
              {step > 1 && (
                <button
                  onClick={handleBack}
                  className="px-6 py-4 rounded-full border border-white/20 text-white font-semibold hover:bg-white/5 transition-all"
                >
                  Atrás
                </button>
              )}
              <button
                onClick={handleNext}
                className="flex-1 py-4 rounded-full bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-[#1a1a3e] font-bold text-lg tracking-wide hover:opacity-90 transition-all shadow-lg shadow-[#FFD700]/20"
              >
                {step === totalSteps ? 'Ver mi figurita →' : 'Continuar →'}
              </button>
            </div>
          </div>
        )}
